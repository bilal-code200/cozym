...
const columnContent = [
	/*  ID 1  */
	{
		...
		fullText: (
			<>
				Discover how Nigeria’s Gas Flare Commercialisation Programme is creating
				new opportunities for EPCC contractors. Learn about engineering
				projects, sustainability benefits, and sector growth.  
