        ...
        <div className="px-4 sm:px-8 md:px-12 lg:px-[50px] py-8 sm:py-12 md:py-16 lg:py-[100px] flex flex-col justify-center text-xs sm:text-sm lg:text-[14px] order-1 md:order-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4">
            <input
              type="text"
              placeholder="Name"
              className="w-full p-3 sm:p-3 rounded-lg bg-[#DEE1DD] text-[#002B45] outline-none"
            />
            <input
              type="email"
          ...
          <textarea
            ...
            className="w-full p-3 sm:p-3 h-24 sm:h-32 lg:h-40 rounded-lg bg-[#DEE1DD] text-[#002B45] outline-none mb-4 sm:mb-6"
          />

          <button className="bg-[#002B45] text-white px-6 sm:px-8 lg:px-10 py-4 sm:py-4 rounded-lg w-fit hover:opacity-90">
            Send a Message
          </button>
        </div>
