...
export default function SlideTwo({ active }) {
    ...
    `}
		>
			...
			<div className="relative max-w-[1200px]  mx-auto h-full w-full flex flex-col items-end pt-[5%]  text-white animate-fadeSlide">
				<div>
					<h1 className="text-[48px] font-extrabold">Key Fact</h1>
					<li className="text-[20px] leading-[29px] text-[#ffffff] font-medium">
