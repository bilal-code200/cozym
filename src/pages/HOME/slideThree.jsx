...
export default function SlideThree({ active }) {
    ...
    `}
		>
			...
			<div className="relative lg:max-w-[1370px] lg:px-[100px] px-10  lg:mx-auto h-full w-full lg:pb-[5%] pb-[20%] flex flex-col items-end justify-end lg:justify-end lg:items-end  pt-[10%]  text-white animate-fadeSlide">
				<div className="">
